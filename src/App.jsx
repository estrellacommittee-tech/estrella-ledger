...
const CATEGORIES_OUT = ["Security", "Housekeeping Salary", "Housekeeping Expense", "Electricity", "Water", "Repairs", "Lift AMC", "Gardener Salary", "Garden Expense", "Admin", "Other Expense"];
